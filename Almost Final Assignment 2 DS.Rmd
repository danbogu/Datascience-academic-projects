...
# asuming that we dont have preference for any kind of FALSE (FP=FN).
```
...
```{r Q-4-l}
glm.q4_try<-glm(income~age_standardize + educational.num_standardize + hours.per.week_standardize +
      race_merged + workclass_merged + marital.status_merged + gender,
        family = binomial,data=data_train)
