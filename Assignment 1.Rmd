...
#Question 9
```{r}
diamondsDB <-data.frame(diamonds)
```

#a.
```{r}
diamondsDB$color <- as.integer(diamondsDB$color)
cor.carat.color <- cor.test(x = diamondsDB$carat,y=diamondsDB$color,method = "pearson")
cor.test(x = diamondsDB$carat,y=diamondsDB$color,method = "spearman")
plot(x = diamondsDB$color, y = diamondsDB$carat)
```
